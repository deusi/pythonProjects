...
Instructions: Simply go to the code directory (in this case it is HW2_Code)
and type "python3 hw2q3.py" in the console. It is recommended using
"python3 -W ignore hw2q3.py", since current implementation throws
...
hw2q3.py", while some linux based machines require specification, i.e.
"python3 -W ignore hw2q3.py".

Python Version: 3.8.3
Numpy Version: 1.18.5
Scikit-learn Version: 0.23.1

Required files (provided in the HW2_Code folder):
- hw2q3.py
