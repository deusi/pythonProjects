...
b50AccuracyLinearSVC = my_train_test.my_train_test(myLinearSVC, X_boston50, y_boston50, 0.75, 10)
...
b25AccuracyLinearSVC = my_train_test.my_train_test(myLinearSVC, X_boston25, y_boston25, 0.75, 10)
...
dAccuracyLinearSVC= my_train_test.my_train_test(myLinearSVC, X_digits, y_digits, 0.75, 10)
...
b50AccuracySVC = my_train_test.my_train_test(mySVC, X_boston50, y_boston50, 0.75, 10)
...
b25AccuracySVC = my_train_test.my_train_test(mySVC, X_boston25, y_boston25, 0.75, 10)
...
dAccuracySVC = my_train_test.my_train_test(mySVC, X_digits, y_digits, 0.75, 10)
...
b50AccuracyLR = my_train_test.my_train_test(myLR, X_boston50, y_boston50, 0.75, 10)
...
b25AccuracyLR = my_train_test.my_train_test(myLR, X_boston25, y_boston25, 0.75, 10)
...
dAccuracyLR = my_train_test.my_train_test(myLR, X_digits, y_digits, 0.75, 10)
